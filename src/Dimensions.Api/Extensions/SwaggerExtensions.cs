...
public static class SwaggerExtensions
{
    public static IServiceCollection AddDimensionsSwagger(this IServiceCollection services)
    {
        services.AddSwaggerGen(options =>
        {
            options.SwaggerDoc("v1", new OpenApiInfo
            {
                ...
                Version = "v1",
                Description = "Dimensions development WebAPI with JWT, SQLite, and log4net."
            });
    ...
    public static IApplicationBuilder UseDimensionsSwagger(this WebApplication app)
    {
        ...
        {
            options.SwaggerEndpoint("/swagger/v1/swagger.json", "Dimensions API v1");
            options.DocumentTitle = "Dimensions API Swagger";
